      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-24 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-1/4 left-10 w-64 h-64 bg-cyan-500 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute bottom-1/4 right-10 w-64 h-64 bg-blue-500 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          </div>
